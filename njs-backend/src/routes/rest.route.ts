...
import itemTypeAttributeGroupMappingRouter from './meta-data/item-type-attribute-group-mapping.route';
import itemTypeAttributeGroupMappingsRouter from './meta-data/item-type-attribute-group-mappings.route';
...
router.use('/ItemTypeAttributeGroupMappings', itemTypeAttributeGroupMappingsRouter);
router.use('/ItemTypeAttributeGroupMapping', itemTypeAttributeGroupMappingRouter);
